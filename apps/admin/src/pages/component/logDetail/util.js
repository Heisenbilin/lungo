...
import { ApiErrorApis } from '/@/api/apiError';
import { GatewayApis } from '/@/api/gateway';
import API from '/@/api/board/sourceMap';
import { getErrDetails, getFaultTolerantErrorDetails } from '/@/api/resourceException';
import { PerformanceApis } from '/@/api/performance';
...
const getPerformanceDetails = async (params, page, pageSize, ua_flag) => {
  const data = await PerformanceApis.getLogDetails({
    ...params,
    limit: pageSize,
    page: page,
    ua_flag,
...
const getResourceDetails = async (params, page, pageSize, ua_flag) => {
  const data = await getErrDetails({
    ...params,
    limit: pageSize,
    page: page,
    ua_flag,
...
const getFaultTolerantDetails = async (params, page, pageSize) => {
  const data = await getFaultTolerantErrorDetails({
    ...params,
    limit: pageSize,
    page: page,
  });
...
const getApiDetails = async (params, page, pageSize, ua_flag) => {
  const data = await ApiErrorApis.getApiDetails({
    ...params,
    limit: pageSize,
    page: page,
    ua_flag,
...
const getGatewayDetails = async (params, page, pageSize, ua_flag) => {
  const data = await GatewayApis.getApiDetails({
    ...params,
    limit: pageSize,
    page: page,
    ua_flag,
