...
import { getErrSummary, getWhiteRate } from '../apis.js';
...
export default {
  ...
  setup(props, context) {
    ...
    const runtimeScore = ref(0);
    const resourceScore = ref(0);
    const whiteScore = ref(0);
    const runtimeData = ref([]);
    const runtimeRate = ref(0);
    ...
    async function initData() {
      ...
      context.emit('stabilityScoreChange', parseFloat(stabilityScore.value));
    }
