...
enum TaskType {
  TOOL_SENDRULENOTICE = '/v1/tool/sendrulenotice',
  REPORT_GETPROJECTBOARDURL = '/v1/report/getProjectBoardUrl',
  REPORT_GETPRODAYPERFORMANCE = '/v1/report/getProDayPerformance',
  REPORT_GETPROJECTRANKING = '/v1/report/getProjectRanking',
  REPORT_GETERRORTOTALSUMMARY = '/v1/report/getErrorTotalSummary',
  REPORT_GETTWOWEEKSSUMMARY = '/v1/report/getTwoWeeksSummary',
  REPORT_GETERRORSUMMARY = '/v1/report/getErrorSummary',
  REPORT_ERR_SUMMARY = '/v1/report/errSummary',
  LIGHTHOUSE_GET_REPORT = '/v1/lighthouse/getReport',
  REPORT_GETAVERAGEPERFORMANCE = '/v1/report/getAveragePerformance',
  REPORT_GET_TWO_WEEKS_AVERAGE = '/v1/report/getTwoWeeksAverage',
  REPORT_CHECK_RESOURCE = '/v1/report/checkResource',
  REPORT_CHECK_CDN = '/v1/report/checkCDN',
  REPORT_GET_PROJECT_LIGHTHOUSE_STATUS = '/v1/report/getProjectLighthouseStatus',
  REPORT_RETRY_LIGHTHOUSE = '/v1/report/retryLighthouse',
  UA_CHARTDATA = '/v1/ua/chartdata',
}
